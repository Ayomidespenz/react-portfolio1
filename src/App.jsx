...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      description:
        "A modern Hospital Management system fullu functioning  built with React.js and Laravel, featuring user authentication,Admin dashboard, rich text editing, patient dashboard , and Doctors/Nurses dashboard.",
      image: HospitalImage,
...

    {
      ...
      title: "Blog Platform",
      description:
        "A modern blog platform built with Vue.js and Laravel, featuring user authentication, rich text editing, comment system, and category management.",
      image: blogImage,
    ...
    },
    {
      ...
      description:
        "A secure and transparent voting platform built with Solidity smart contracts on Ethereum. Features include voter verification, real-time vote counting, and tamper-proof results.",
      image:
        "https://images.unsplash.com/photo-1639322537504-6427a16b0a28?w=400&h=250&fit=crop",
    ...
    },
    {
      ...
      description:
        "An interactive portfolio website showcasing skills. Features stunning visuals and smooth animations.",
      image: portImage,
    ...
    },
    {
      ...
      description:
        "A comprehensive library system for managing books, memberships, and loans. Includes features for cataloging, search, and user tracking.",
      image: libraryImage,
    ...
    },
    {
      ...
      description:
        "A responsive e-commerce platform with product catalog, shopping cart, and checkout functionality. Features include product filtering and search.",
      image: commerceImage,
      tech: ["HTML", "JavaScript", "Bootstrap"],
    ...
    },
    {
      ...
      title: "Gym Website",
      description:
        "A modern fitness website with membership plans, class schedules, and trainer profiles. Includes BMI calculator and workout tracking features.",
      image: gymImage,
      tech: ["HTML", "JavaScript", "Bootstrap"],
  ...
  const experience = [
    {
      ...
      period: "2025 - Present",
      description:
        "Led development of enterprise web applications using React , Vuejs and Laravel",
    },
    {
      ...
      period: "2025 - present",
      description:
        "Created responsive web interfaces and improved user experience",
    },
    {
      ...
      period: "2024 - present",
      description:
        "Contributed to various projects using modern web technologies",
    },
  ];
  ...
  return (
    ...
    >
        ...
        <div className="container text-center">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h1
                className="display-2 display-md-3 display-sm-5 fw-bold mb-3 typewriter-text"
                style={{
              ...
              <div
                className="text-cycler fs-2 mb-4"
              ...
              <p
                className="lead mb-4 animate-text"
                style={{
              ...
              >
                Building modern web applications and exploring blockchain
                technology
              </p>
              <div
              ...
              >
                <button
                  className="btn btn-primary btn-md btn-sm px-md-4 px-sm-3 py-md-2 py-sm-1 rounded-pill"
              ...
              btn-lg btn-md btn-sm px-lg-4 px-md-3 px-sm-2 py-lg-2 py-md-1 rounded-pill`}
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <p className="lead mb-4">
                ...
                modern JavaScript frameworks, backend development with
                PHP/Laravel, and blockchain technology.
              </p>
              <p className="mb-4">
                My journey in tech started with a curiosity about how things
                work behind the scenes. Today, I combine technical expertise
                with creative problem-solving to build applications that make a
                difference.
              </p>
              <div className="d-flex gap-3">
                <a
                  href="https://github.com/Ayomidespenz"
                ...
                <a
                  href="https://www.linkedin.com/in/quadri-yusuff-adisa"
                  className="btn btn-outline-primary"
                  target="_blank"
                  rel="noopener noreferrer"
                >
      ...
      <section
        id="skills"
        className={`py-5 ${darkMode ? "bg-secondary" : "bg-light"}`}
      >
        <div className="container">
      ...
      <footer
        className={`py-4 ${
          darkMode ? "bg-dark border-top" : "bg-light border-top"
        }`}
      >
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              <p className="mb-0">
                &copy; 2025 Quadri Yusuff. All rights reserved.
              </p>
            </div>
